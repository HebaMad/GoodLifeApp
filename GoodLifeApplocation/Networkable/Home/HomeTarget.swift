...
enum HomeApiTarget:TargetType{
    ...
    var method: Moya.Method {
        switch self{
        case .Home,.getNeedMainCategory,.getNeedSubCategory,.categoriesFiltering,.getOpportunities,.oppourtinityDetails:
            return .get
    ...
    var headers: [String : String]?{
        switch self{
        case .Home,.categoriesFiltering,.getOpportunities,.oppourtinityDetails:
            //            do {
