...
open class CheckBox: UIControl {
    ...
    @IBInspectable
    var uncheckedBorderColor: UIColor = #colorLiteral(red: 0, green: 0.4745098039, blue: 0.7607843137, alpha: 1)
...
//            self.isChecked = newValue.checkBoxDesign.startCheckedStatus
    ...
    private func setupViews() {
        self.borderWidth = 1
        self.uncheckedBorderColor = UIColor(named: "button") ?? .clear
        self.backgroundColor = .white
        self.tintColor = UIColor(named: "button")
    }
