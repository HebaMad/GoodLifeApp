...
internal extension UIView {
    ...
    func cd_alignBottomToParent(with margin: CGFloat) {
        cd_alignToBottom(of: self.superview ?? UIView(), margin: margin)
    }
    ...
    func cd_alignLeftToParent(with margin: CGFloat) {
        cd_alignToLeft(of: self.superview ?? UIView(), margin: margin)
    }
    ...
    func cd_alignRightToParent(with margin: CGFloat) {
        cd_alignToRight(of: self.superview ?? UIView(), margin: margin)
    }
